      ...
      <div className="w-full md:px-6">
        ...
        <div className="text-center md:text-left">
          ...
          <MediaReveal as="p" y={20} scale={1} duration={0.9} delay={0.1} className="mx-auto mt-7 max-w-xl text-[15px] font-light leading-relaxed text-ink/60 md:mx-0">
            Не виджет поддержки, а часть бренда. Поможет записаться, расскажет об услугах
            и мастерах, рассчитает стоимость, найдёт ближайшее окно и подскажет базовый уход.
          </MediaReveal>
